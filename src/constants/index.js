  ...
  const projects = {
    en: [
    {
      ...
      tags: [
        ...
        { name: "RAG", color: "green-text-gradient" },
        { name: "Knowledge Base", color: "yellow-text-gradient" },
      ...
      image: [uscisRepoCover, uscisBanner, uscisAtlasClusters, uscisAtlasOverview, uscisAtlasNeighbours, uscisAtlasZoom, uscisGithubRepo, uscisHuggingfaceRepo],
    ...
    es: [
      {
        ...
        tags: [
          ...
          { name: "VectorDB", color: "blue-text-gradient" },
          { name: "RAG", color: "green-text-gradient" },
          { name: "Base de Conocimiento", color: "yellow-text-gradient" },
          { name: "Web Scraping", color: "orange-text-gradient" },
          { name: "Docker", color: "blue-text-gradient" },
          { name: "PostgreSQL", color: "green-text-gradient" },
          { name: "Neo4j", color: "purple-text-gradient" },
